...
import ChatDetails from "../../components/chat-page/ChatDetails";
import Loader from "../../components/Loader";
import MessageInput from "../../components/chat-page/MessageInput";
import ImageModal from "../../components/chat-page/ImageModal";
...
export default function MessageArea({ selectedUser, setSelectedUser }) {
  ...
  return (
    <>
      {ModalImage && <ImageModal image={ModalImage} setModalImage={setModalImage}/>}
      <div
